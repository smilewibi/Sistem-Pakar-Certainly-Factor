...
class KonsultasiController extends Controller
{
    ...
    public function actionHasilkonsultasi()
    {
        ...
        $PM001 = $db->createCommand("SELECT * FROM hasil_konsultasi, gejala,pakar,diagnosa 
                                    WHERE hasil_konsultasi.hid_konsultasi=".$id." 
                                    AND hasil_konsultasi.hkode_gejala=pakar.pkode_gejala
                                    AND pakar.pkode_gejala=gejala.kode_gejala
                                    AND pakar.pkode_diagnosa='PM001'  
                                    AND pakar.pkode_diagnosa=diagnosa.kode_diagnosa
                                    ORDER BY diagnosa.kode_diagnosa")->queryAll();
        //$countPM001 = round(0.4+0.1*(1-0.4), 2);
        $PM002 = $db->createCommand("SELECT * FROM hasil_konsultasi, gejala,pakar,diagnosa 
                                    WHERE hasil_konsultasi.hid_konsultasi=".$id." 
                                    AND hasil_konsultasi.hkode_gejala=pakar.pkode_gejala
                                    AND pakar.pkode_gejala=gejala.kode_gejala
                                    AND pakar.pkode_diagnosa='PM002'  
                                    AND pakar.pkode_diagnosa=diagnosa.kode_diagnosa
                                    ORDER BY diagnosa.kode_diagnosa")->queryAll();
        $PM003 = $db->createCommand("SELECT * FROM hasil_konsultasi, gejala,pakar,diagnosa 
                                    WHERE hasil_konsultasi.hid_konsultasi=".$id." 
                                    AND hasil_konsultasi.hkode_gejala=pakar.pkode_gejala
                                    AND pakar.pkode_gejala=gejala.kode_gejala
                                    AND pakar.pkode_diagnosa='PM003'  
                                    AND pakar.pkode_diagnosa=diagnosa.kode_diagnosa
                                    ORDER BY diagnosa.kode_diagnosa")->queryAll();
        $PM004 = $db->createCommand("SELECT * FROM hasil_konsultasi, gejala,pakar,diagnosa 
                                    WHERE hasil_konsultasi.hid_konsultasi=".$id." 
                                    AND hasil_konsultasi.hkode_gejala=pakar.pkode_gejala
                                    AND pakar.pkode_gejala=gejala.kode_gejala
                                    AND pakar.pkode_diagnosa='PM004'  
                                    AND pakar.pkode_diagnosa=diagnosa.kode_diagnosa
                                    ORDER BY diagnosa.kode_diagnosa")->queryAll();
        $PM005 = $db->createCommand("SELECT * FROM hasil_konsultasi, gejala,pakar,diagnosa 
                                    WHERE hasil_konsultasi.hid_konsultasi=".$id." 
                                    AND hasil_konsultasi.hkode_gejala=pakar.pkode_gejala
                                    AND pakar.pkode_gejala=gejala.kode_gejala
                                    AND pakar.pkode_diagnosa='PM005'  
                                    AND pakar.pkode_diagnosa=diagnosa.kode_diagnosa
                                    ORDER BY diagnosa.kode_diagnosa")->queryAll();
        $PM006 = $db->createCommand("SELECT * FROM hasil_konsultasi, gejala,pakar,diagnosa 
                                    WHERE hasil_konsultasi.hid_konsultasi=".$id." 
                                    AND hasil_konsultasi.hkode_gejala=pakar.pkode_gejala
                                    AND pakar.pkode_gejala=gejala.kode_gejala
                                    AND pakar.pkode_diagnosa='PM006'  
                                    AND pakar.pkode_diagnosa=diagnosa.kode_diagnosa
                                    ORDER BY diagnosa.kode_diagnosa")->queryAll();
        $PM007 = $db->createCommand("SELECT * FROM hasil_konsultasi, gejala,pakar,diagnosa 
                                    WHERE hasil_konsultasi.hid_konsultasi=".$id." 
                                    AND hasil_konsultasi.hkode_gejala=pakar.pkode_gejala
                                    AND pakar.pkode_gejala=gejala.kode_gejala
                                    AND pakar.pkode_diagnosa='PM007'  
                                    AND pakar.pkode_diagnosa=diagnosa.kode_diagnosa
                                    ORDER BY diagnosa.kode_diagnosa")->queryAll();
        $PM008 = $db->createCommand("SELECT * FROM hasil_konsultasi, gejala,pakar,diagnosa 
                                    WHERE hasil_konsultasi.hid_konsultasi=".$id." 
                                    AND hasil_konsultasi.hkode_gejala=pakar.pkode_gejala
                                    AND pakar.pkode_gejala=gejala.kode_gejala
                                    AND pakar.pkode_diagnosa='PM008'  
                                    AND pakar.pkode_diagnosa=diagnosa.kode_diagnosa
                                    ORDER BY diagnosa.kode_diagnosa")->queryAll();
        //$pakar = Konsultasi::find();
        //$result = mysqli_query($db, $pakar);

        return $this->render('hasilkonsultasi',[
            'data' => $data,
            'PM001'=>$PM001,
            //'countPM001'=>$countPM001,
            'PM002'=>$PM002,
            'PM003'=>$PM003,
            'PM004'=>$PM004,
            'PM005'=>$PM005,
